...
mandatory_html = """
              ...
              <div>
                ...
                <input type="text" name="sl_no" required value="{{ values.sl_no }}" style="width:100%; background:var(--bg-raised); border:1px solid var(--border); color:var(--text-primary); padding:10px 14px; border-radius:var(--radius-input); font-family:var(--font-ui); font-size:14px; outline:none;">
              </div>
              <div>
                ...
                <input type="text" name="monitor_make" required value="{{ values.monitor_make }}" style="width:100%; background:var(--bg-raised); border:1px solid var(--border); color:var(--text-primary); padding:10px 14px; border-radius:var(--radius-input); font-family:var(--font-ui); font-size:14px; outline:none;">
              </div>
              <div>
                ...
                <input type="text" name="monitor_serial_no" required value="{{ values.monitor_serial_no }}" style="width:100%; background:var(--bg-raised); border:1px solid var(--border); color:var(--text-primary); padding:10px 14px; border-radius:var(--radius-input); font-family:var(--font-ui); font-size:14px; outline:none;">
              </div>
              <div>
                ...
                <input type="text" name="asset_owner_pl_no" required value="{{ values.asset_owner_pl_no }}" style="width:100%; background:var(--bg-raised); border:1px solid var(--border); color:var(--text-primary); padding:10px 14px; border-radius:var(--radius-input); font-family:var(--font-ui); font-size:14px; outline:none;">
              </div>
              <div>
                ...
                <select name="asset_usage_status" required style="width:100%; background:var(--bg-raised); border:1px solid var(--border); color:var(--text-primary); padding:10px 14px; border-radius:var(--radius-input); font-family:var(--font-ui); font-size:14px; outline:none;">
                  ...
                  <option value="In Use" {% if values.asset_usage_status == 'In Use' %}selected{% endif %}>In Use</option>
                  <option value="Condemn" {% if values.asset_usage_status == 'Condemn' %}selected{% endif %}>Condemn</option>
                </select>
              </div>
              <div>
                ...
                <select name="in_warranty_status" required style="width:100%; background:var(--bg-raised); border:1px solid var(--border); color:var(--text-primary); padding:10px 14px; border-radius:var(--radius-input); font-family:var(--font-ui); font-size:14px; outline:none;">
                  <option value="">Select...</option>
                  <option value="Yes" {% if values.in_warranty_status == 'Yes' %}selected{% endif %}>Yes</option>
                  <option value="No" {% if values.in_warranty_status == 'No' %}selected{% endif %}>No</option>
                  <option value="In Maintenance" {% if values.in_warranty_status == 'In Maintenance' %}selected{% endif %}>In Maintenance</option>
                </select>
              </div>
"""
...
for field, label in fields:
    optional_html += f"""
                <div>
                  ...
                  <input type="text" name="{field}" value="{{{{ values.{field} }}}}" style="width:100%; background:var(--bg-raised); border:1px solid var(--border); color:var(--text-primary); padding:10px 14px; border-radius:var(--radius-input); font-family:var(--font-ui); font-size:14px; outline:none;">
                </div>"""
